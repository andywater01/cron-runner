...
Version **0.1.1**. Full instructions, including how to get past the unsigned-app warnings, are
in [docs/INSTALL.md](docs/INSTALL.md).

| Platform | Download |
| --- | --- |
| macOS, Apple silicon | [CronRunner-0.1.1-macos-arm64.dmg](https://github.com/andywater01/cron-runner/releases/download/v0.1.1/CronRunner-0.1.1-macos-arm64.dmg) |
| macOS, Intel | [CronRunner-0.1.1-macos-x64.dmg](https://github.com/andywater01/cron-runner/releases/download/v0.1.1/CronRunner-0.1.1-macos-x64.dmg) |
| Windows, 64-bit | [CronRunner-0.1.1-windows-x64.exe](https://github.com/andywater01/cron-runner/releases/download/v0.1.1/CronRunner-0.1.1-windows-x64.exe) |
| Linux, 64-bit | [CronRunner-0.1.1-linux-x64.tar.gz](https://github.com/andywater01/cron-runner/releases/download/v0.1.1/CronRunner-0.1.1-linux-x64.tar.gz) |
